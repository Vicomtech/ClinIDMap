...
# DATA
df_train = pd.read_csv('medprocner_train/tsv/medprocner_tsv_train_subtask2.tsv', sep='\t', dtype='str')
...
if os.path.exists(output_file_corpus): 
    ...
    queries_chunks = get_chunks(queries0, 1000)
